...
- [awesome-project](/issues/2312)

**Después de la versión `v4.1.0+`, la rama por defecto master no tendrá soporte para i18n. Por favor utilice la rama [i18n](/tree/i18n), los cambios serán incluidos en la rama master**

**la versión actual es `v4.0+` construida con `vue-cli`. Si encuentra algún problema, por favor coloque un [issue](/issues/new). Si desea usar la versión anterior, puede cambiar de rama a [tag/3.11.0](/tree/tag/3.11.0), no relacionado con `vue-cli`**
...
Los cambios detallados por cada liberación se encuentran en [notas de liberación](/releases).
